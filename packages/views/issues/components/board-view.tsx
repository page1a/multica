...
function BoardViewImpl({
  ...
  const handleDragEnd = useCallback(
    ...
    [applyPropertyGroupValue, beginSettle, catalog, columnsRef, groupIds, groupMap, groupedIssues, grouping, groupingOptionIds, groups, isDraggingRef, onMoveIssue, pinnedIssueIds, setColumns, sortBy, t],
  );
